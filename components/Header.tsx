                ...
                {user.email && (
                  ...
                  >
                    <div className="relative shrink-0">
                      ...
                      {unreadCount > 0 && (
                        <span className="absolute -top-1.5 -right-1.5 bg-primary text-primary-foreground text-[9px] font-bold w-4 h-4 flex items-center justify-center rounded-full leading-none">
                          {unreadCount > 99 ? "99+" : unreadCount}
                        </span>
                      )}
                    </div>
                    <span className="text-xs uppercase tracking-[0.25em] font-medium">Notifications</span>
                    {unreadCount > 0 && (
                      <span className="ml-auto bg-primary text-primary-foreground text-xs px-2 py-0.5 rounded-full font-medium">
                        {unreadCount}
                      </span>
                    )}
                  </Link>
