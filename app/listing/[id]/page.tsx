              ...
              <CardContent className="p-4 sm:p-6">
                <div className="flex justify-between items-start w-full">
                  ...
                  <Badge
                    ...
                    variant="outline"
                  >
                    {car.seller.is_verified ? "✓ Verified" : "Unverified"}
                  </Badge>
                </div>
                <div className="flex flex-wrap gap-2 sm:gap-3 mt-4 border-t py-4">
                  {car.seller.contact_number && (
                    <div className="flex gap-2 w-full mb-1">
                      <a
                        href={`https://wa.me/${car.seller.contact_number.replace(/\D/g, "")}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        title="Chat on WhatsApp"
                        className="flex-1 flex items-center justify-center gap-2 py-2.5 px-3 rounded-md border-0 sm:border sm:border-green-500 text-green-600 hover:bg-green-50 transition-colors text-sm font-medium"
                      >
                        <svg className="w-9 h-9 sm:w-5 sm:h-5 shrink-0" viewBox="0 0 24 24" fill="currentColor">
                      ...
                      <a
                        href={`https://t.me/${car.seller.contact_number.replace(/\s/g, "")}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        title="Message on Telegram"
                        className="flex-1 flex items-center justify-center gap-2 py-2.5 px-3 rounded-md border-0 sm:border sm:border-blue-400 text-blue-500 hover:bg-blue-50 transition-colors text-sm font-medium"
                      >
                        <svg className="w-9 h-9 sm:w-5 sm:h-5 shrink-0" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <Button
                    ...
                    className="w-full bg-primary text-primary-foreground hover:bg-primary-hover flex items-center justify-center gap-2 cursor-pointer"
                  >
